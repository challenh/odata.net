...
"));
        ...
        public void RequestSingleAnnotation()
        {
            ...
            context.Configurations.ResponsePipeline
                ...
                {
                    entityMaterialised = true;
                    Assert.IsTrue(args.Entry.InstanceAnnotations.Count() <= 1, "No entity annotations were requested except @odata.type");
                })
                .OnFeedEnded((args) =>
                {
                    feedMaterialised = true;
        ...
        public void RequestWithMultipleIncludeAnnotationsHeaders()
        {
            ...
            context.Configurations.ResponsePipeline
                ...
                {
                    entityMaterialised = true;
                    Assert.IsTrue(args.Entry.InstanceAnnotations.Count <= 1, "negative filter should result in no annotations except @odata.type");
                })
                .OnFeedEnded((args) =>
                {
                    feedMaterialised = true;
