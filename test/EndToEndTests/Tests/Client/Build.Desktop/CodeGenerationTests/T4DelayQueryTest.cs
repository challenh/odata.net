...
namespace Microsoft.Test.OData.Tests.Client.CodeGenerationTests
{
    ...
    public class T4DelayQueryTest : ODataWCFServiceTestsBase<InMemoryEntities>
    {
        ...
        [Ignore] // comment out to run perf comparison test
        [TestMethod]
        public void CompareFullAndLiteDeserializers()
        {
            ...
            {
                // 1:
                TestClientContext.MetadataValidationLevel = Microsoft.OData.MetadataValidationLevel.Full;
                var milli = 0L;
                List<Product> list1;
                {
                ...
                // 2:
                TestClientContext.MetadataValidationLevel = Microsoft.OData.MetadataValidationLevel.Lite;
                var milli2 = 0L;
                List<Product> list2;
                {
