namespace Microsoft.Test.OData.TDD.Tests.Reader.JsonLight
{
    ...
    public class ODataJsonLightEntryAndFeedDeserializerUndeclaredAnnotationTests
    {
        ...
        public void ReadNestedAnnotationInOpenEntryUndeclaredComplexTest()
        {
            ...
            undeclaredComplex1Val.GetAnnotation<ODataValueRawAnnotations>().Should().BeNull(); // normal dynamic property in open entity has no raw ODataRawAnnotations.
            ...
            undeclaredComplex1Innerstr.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(4);
            undeclaredComplex1Innerstr.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"od unkown value _234\"");
            undeclaredComplex1Innerstr.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"custom annotation value _234\"");
        ...
        public void ReadNestedAnnotationInNonOpenEntryUndeclaredComplexTest()
        {
            ...
            ODataComplexValue undeclaredComplex1Val = entry.Properties.Single(s => string.Equals(s.Name, "undeclaredComplex1"))
                .ODataValue as ODataComplexValue;
            undeclaredComplex1Val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(3);
            undeclaredComplex1Val.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"od unkown value 1\"");
            undeclaredComplex1Val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"custom annotation value 1\"");
        ...
        public void ReadNonOpenNullTest()
        {
            ...
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(3);
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"NS1.unknownTypeName123\"");
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"uknown abcdefghijk value2\"");
        ...
        public void ReadNonOpenknownTypeBoolTest()
        {
            ...
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(2);
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"unknown odata.xxx value1\"");
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"unknown abcdefghijk value2\"");
        ...
        public void ReadNonOpenknownTypeStringTest()
        {
            ...
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(3);
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"Edm.String\"");
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"unknown abcdefghijk value2\"");
        ...
        public void ReadNonOpenknownTypeNumericTest()
        {
            ...
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(3);
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"Edm.Double\"");
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"unknown abcdefghijk value2\"");
        ...
        public void ReadNonOpenKnownTypeComplexTest()
        {
            ...
            UndeclaredAddress1Value.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(2);
            UndeclaredAddress1Value.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"unknown odata.xxx value1\"");
            UndeclaredAddress1Value.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"unknown abcdefghijk value2\"");
        ...
        public void ReadNonOpenKnownTypeCollectionTest()
        {
            ...
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Count().Should().Be(3);
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.First().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"Collection(Edm.String)\"");
            val.GetAnnotation<ODataValueRawAnnotations>().Annotations.Last().Value.As<ODataUntypedValue>().RawValue.Should().Be("\"unknown abcdefghijk value2\"");
